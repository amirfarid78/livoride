                        ...
                        <form method="POST" class="needs-validation user-add" id="settingsForm"
                            ...
                            <div class="tab-content w-100" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="general_settings" role="tabpanel"
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2"
                                            for="general[frontend_enable]">{{ __('Enable Built-in Frontend') }}
                                            <i class="ri-error-warning-line" data-bs-toggle="tooltip"
                                                data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                                data-bs-title="{{ __('Toggle to turn on or off the built-in frontend landing page. If turned off, root visits will redirect to the login page or the external frontend.') }}"></i>
                                        </label>
                                        <div class="col-md-10">
                                            <div class="editor-space">
                                                <label class="switch">
                                                    @if (isset($settings['general']['frontend_enable']))
                                                    <input class="form-control" type="hidden"
                                                        name="general[frontend_enable]" value="0">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="general[frontend_enable]" value="1"
                                                        {{ $settings['general']['frontend_enable'] ? 'checked' : '' }}>
                                                    @else
                                                    <input class="form-control" type="hidden"
                                                        name="general[frontend_enable]" value="0">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="general[frontend_enable]" value="1" checked>
                                                    @endif
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2"
                                            for="general[external_frontend_enable]">{{ __('Enable External Frontend') }}
                                            <i class="ri-error-warning-line" data-bs-toggle="tooltip"
                                                data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                                data-bs-title="{{ __('Toggle to redirect the home landing page to a custom external URL.') }}"></i>
                                        </label>
                                        <div class="col-md-10">
                                            <div class="editor-space">
                                                <label class="switch">
                                                    @if (isset($settings['general']['external_frontend_enable']))
                                                    <input class="form-control" type="hidden"
                                                        name="general[external_frontend_enable]" value="0">
                                                    <input class="form-check-input" type="checkbox"
                                                        name="general[external_frontend_enable]" value="1"
                                                        {{ $settings['general']['external_frontend_enable'] ? 'checked' : '' }}>
                                                    @else
                                                    <input class="form-control" type="hidden"
                                                        name="general[external_frontend_enable]" value="0">
                                                    <input class="form-check-input" type="checkbox"
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-2"
                                            for="general[external_frontend_url]">{{ __('External Frontend URL') }}
                                            <i class="ri-error-warning-line" data-bs-toggle="tooltip"
                                                data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                                data-bs-title="{{ __('Provide the complete external URL (including http/https).') }}"></i>
                                        </label>
                                        <div class="col-md-10">
                                            <input class="form-control" type="url" id="general[external_frontend_url]"
                                                name="general[external_frontend_url]"
                                                value="{{ $settings['general']['external_frontend_url'] ?? old('external_frontend_url') }}"
                                                placeholder="https://example.com">
                                            @error('general.external_frontend_url')
                                            <span class="invalid-feedback d-block" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                            @enderror
                                    ...
                                    <div class="form-group row">
                                         ...
                                         <div class="col-xxl-9 col-md-8">
                                             <input type="color" class="form-control color-picker"
                                                 ...
                                                 value="{{ $settings['appearance']['primary_color'] ?? '#E5AC25' }}">
                                         </div>
                                     </div>
                                     ...
                                     <div class="form-group row">
                                         ...
                                         <div class="col-xxl-9 col-md-8">
                                             <input type="color" class="form-control color-picker"
                                                 ...
                                                 value="{{ $settings['appearance']['secondary_color'] ?? '#1E1E1E' }}">
                                         </div>
                                     </div>
                                     {{-- @dd($id); --}}
                                     <div class="form-group row">
                                     ...
                                     <div id="solid-color-container" class="form-group row" style="display: none;">
                                         ...
                                         <div class="col-md-9">
                                             <input type="color" class="form-control color-picker"
                                                 ...
                                                 value="{{ $settings['appearance']['sidebar_solid_color'] ?? '#1E1E1E' }}">
                                         </div>
                                     </div>
                                     ...
                                     <div id="gradient-color-container" class="form-group row" style="display: none;">
                                         ...
                                         <div class="col-md-4">
                                             <input type="color" class="form-control color-picker"
                                                 ...
                                                 value="{{ $settings['appearance']['sidebar_gradient_color_1'] ?? '#242424' }}">
                                         </div>
                                     </div>
                                     ...
                                     <div id="gradient-color-container-2" class="form-group row"
                                         ...
                                         <div class="col-md-4">
                                             <input type="color" class="form-control color-picker"
                                                 ...
                                                 value="{{ $settings['appearance']['sidebar_gradient_color_2'] ?? '#0C0C0C' }}">
                                         </div>
                                     </div>
