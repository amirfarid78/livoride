...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('users', function($table) {
            ...
            $table->integer('can_accept_ride')->default(1)->nullable();
            $table->integer('can_accept_parcel')->default(1)->nullable();
            $table->integer('can_accept_ride_request')->default(1)->nullable();
            $table->integer('can_accept_parcel_request')->default(1)->nullable();
        });
    ...
    public function down(): void
    {
        Schema::table('users', function($table) {
            ...
            $table->dropColumn('can_accept_ride');
            $table->dropColumn('can_accept_parcel');
            $table->dropColumn('can_accept_ride_request');
            $table->dropColumn('can_accept_parcel_request');
        });
